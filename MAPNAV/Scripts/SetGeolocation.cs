...
public class SetGeolocation : MonoBehaviour
{
    ...
    void GeoLocation()
    {
		...
		transform.position = new Vector3(((lon * 20037508.34f) / 18000) - initX, transform.position.y/*height / 100*/, ((Mathf.Log(Mathf.Tan((90 + lat) * Mathf.PI / 360)) / (Mathf.PI / 180)) * 1113.19490777778f) - initZ);
